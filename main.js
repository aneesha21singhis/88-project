...
function my_keydown(e)
{
	...
	if((ball_x == hole_x )&&(ball_y = innerHTML ="you have hit the goal"))
     document.getElementById("hd3").innerHTML = "you have hit the goal!!";
    document.getElementById("myCanavs").style.bordercolro="red";
	    
{
	...
	function up()
	{
		if(ball_y>=0){
			...
			console.log("block Image height ="+black_image_height);
